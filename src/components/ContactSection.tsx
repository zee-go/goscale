    ...
    <>
      ...
      <section id="contact-form" ref={ref} className="py-24 px-6 bg-gradient-to-br from-[--off-white] to-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className={`text-4xl md:text-5xl font-black text-[--charcoal] mb-6 transition-all duration-700 ease-in-out ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
            Ready to Break Through Your Limits?
          </h2>
          <p className={`text-xl text-[--steel-blue] mb-12 transition-all duration-700 ease-in-out delay-100 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
          ...
          <form 
            ...
            className={`space-y-6 transition-all duration-700 ease-in-out delay-200 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2 text-left">
                ...
                <Input 
                  ...
                  className="border-2 border-gray-200 focus:border-[--teal] transition-all duration-300 ease-in-out"
                  required
                />
              </div>
              <div className="space-y-2 text-left">
            ...
            <div className="space-y-2 text-left">
              ...
              <Select value={formData.adSpend} onValueChange={(value) => setFormData({ ...formData, adSpend: value })} required>
                <SelectTrigger className="border-2 border-gray-200 focus:border-[--teal] transition-all duration-300 ease-in-out">
            ...
            <button 
              type="submit"
              className="cta-button w-full text-lg flex items-center justify-center gap-2"
            >
