    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#FAFAFA] via-white to-[#F0FFFE]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
        <h1
          ...
          style={{ fontFamily: "Satoshi, sans-serif", fontSize: "80px", lineHeight: "", fontStyle: "normal", textDecoration: "none", backgroundColor: "#00000000" }}>

          Unlocking Ad Potential for Brands and Teams Ready to Scale
        </h1>
        
        <p className="text-xl md:text-2xl text-[#6D8CA6] mb-12 max-w-3xl mx-auto" style={{ fontFamily: "Outfit, sans-serif", fontSize: "32px", lineHeight: "1" }}>
